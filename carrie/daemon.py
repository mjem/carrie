...
class Daemon(object):
	...
	def daemonize(self):
		...
		sys.stderr.write('daemon daemonize\n')
		try:
			pid = os.fork()
			if pid > 0:
				# exit first parent
		...
		sys.stderr.write('creating pidfile\n')
		# write pidfile
	...
	def start(self):
		...
		if pid:
			message = "pidfile %s (PID %d) already exists. Daemon already running?\n"
